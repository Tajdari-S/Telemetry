...
H100_FP16_TFLOPS = 1979.0   # tensor-core FP16 (matrix)
H100_FP32_TFLOPS =   67.0   # CUDA-core FP32
H100_MEM_BW_GBPS = 3350.0   # HBM3 bandwidth
NVLINK_BW_GBPS   =  124.0   # measured unidirectional NV6 peak (T1 result)
ELEM_BYTES       =      4   # FP32 weight/gradient storage

RESULTS_DIR = Path("/root/Telemetry/week4/results/scaling")
