...
Output:
  ...
  week7/results/windows_60s.parquet   — 60s sliding-window feature matrix
  week7/results/windows_120s.parquet  — 120s sliding-window feature matrix
...
WEEK4 = Path(__file__).parent.parent.parent / "week7"
